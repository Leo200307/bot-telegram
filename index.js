...
📌 **EXTRANJERO 🌍**`,
        ...
        // ===== QR BOLIVIA =====
            ...
            await bot.editMessageMedia(
                {
                    type: 'photo',
                    media: 'https://i.postimg.cc/mZ6vsVQd/IMG-20260616-WA0038.jpg',
                    caption: `🇧🇴 * PAGA 150 BS*
                ...
                },
                {
                    ...
                    reply_markup: {
                        inline_keyboard: [
                            ...
                            [{ 
  text: '✅ Ya pagué', 
  url: 'https://t.me/bebecita0077?text=Hola%20Pamela,%20te%20mando%20la%20captura,%20pagué%20por%20QR%20Bolivia' 
}]
                        ]
                    }
                }
                ...
                },
                {
                    ...
                    reply_markup: {
                        inline_keyboard: [
                            ...
                            [{ 
  text: '✅ Enviar captura', 
  url: 'https://t.me/bebecita0077?text=Hola%20Pamela,%20te%20mando%20la%20captura,%20pagué%20por%20PayPal' 
}]
                        ]
                    }
                }
                ...
                },
                {
                    ...
                    reply_markup: {
                        inline_keyboard: [
                            ...
                            [{ 
  text: '📤 Enviar captura', 
  url: 'https://t.me/bebecita0077?text=Hola%20Pamela,%20te%20mando%20la%20captura,%20pagué%20con%20tarjeta' 
}],
                            [{ text: '⬅️ Volver', callback_data: 'metodo_pago' }]
                        ]
                    }
                ...
                },
                {
                    ...
                    reply_markup: {
                        inline_keyboard: [
                            ...
                            [{ 
  text: '✅ Enviar captura', 
  url: 'https://t.me/bebecita0077?text=Hola%20Pamela,%20te%20mando%20la%20captura,%20pagué%20por%20Binance' 
}]
                        ]
                    }
                }
